            ...
            <div class="grid-form">
                ...
                <div class="grid-form1">
                    ...
                    <div class="tab-content">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/Admin/speciality_save" method="post" class="form-horizontal">
                ...
                <div class="grid-form1">
                    ...
                    <?php if(COUNT($program_text) > 0){ ?>
                        <p><?php echo $program_text[0]->speciality_desc; ?></p>   
                        <div style="margin-top: 10px;"></div>
                        <a href="<?php echo base_url(); ?>index.php/Admin/delete_data/cbsc_speciality/<?php echo $program_text[0]->id; ?>"><button class="btn btn-danger btn-xs" data-title="Delete">Delete</button></a> 
                    <?php } ?>
                    </div>
                </div>
            </div>
