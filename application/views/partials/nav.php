        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./"><img style="width: 57%; padding: 0px;" src="<?php echo base_url(); ?>assets/img/logo.png"></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
						...
						<li class="<?php echo ( $title == 'Mission' ? 'active':''); ?>"><a class="waves-effect waves-dark" href="<?php echo base_url(); ?>index.php/Mission">Mission</a></li>
                        ...
                        <li class="<?php echo ( $title == 'Contact' ? 'active':''); ?>"><a class="waves-effect waves-dark" href="<?php echo base_url(); ?>index.php/Contact">Contact Us</a></li>
					</ul>
                </div>
            </div>
        </div>
